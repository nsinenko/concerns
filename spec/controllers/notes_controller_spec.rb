  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved note as @note" do
        ...
        post :create, {:note => { "project" => "invalid value" }}, valid_session
        expect(assigns(:note)).to be_a_new(Note)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested note" do
        ...
        expect_any_instance_of(Note).to receive(:update).with({ "project" => "" })
        put :update, {:id => note.to_param, :note => { "project" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the note as @note" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Note.any_instance.stub(:save).and_return(false)
        put :update, {:id => note.to_param, :note => { "project" => "invalid value" }}, valid_session
        expect(assigns(:note)).to eq(note)
      end
